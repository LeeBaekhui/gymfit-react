...
import FoodApp from "./components/foodCalorie/FoodApp";
import {
...
const FoodCalorie = () => {
  ...
  return (
    <div>
      <h1>Food Calorie</h1>
      <p>이 페이지는 Food Calorie 페이지입니다.</p>
      <button onClick={goToMain}>메인으로 이동</button>
    </div>
  );
};
    ...
    <div>
      <nav className={styles.navBar}>
        <ul className={styles.navList}>
          ...
          <li className={styles.navItem}>
            <Link to="/Food Calorie" className={styles.navLink}>
              FoodCalorie
            </Link>
          </li>
        </ul>
    ...
    <Router>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="/foodCalorie" element={<FoodApp />} />
